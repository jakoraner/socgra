### Project A – 60s Video: “Movies as a Network of Ideas” (Simple, one speaker)

Goal: Single person presents the project in an empty cinema. Minimal shots, clear overlays from your notebook. Total 60s, easy to shoot and edit.

### Structure (timecoded, 5 beats, one speaker)
0–8s — Intro on camera  
- Shot: Presenter seated in the cinema, projector on behind them. Static tripod.  
- Dialogue (on‑camera): “What if movies aren’t just rated—but connected by ideas?”  
- Overlay: Title (center): “Movies as a Network of Ideas”.

9–20s — Data and text idea  
...
- Dialogue: “This is a map of cinema drawn by audience language. Next, we’ll compare clusters with topics and explore how influence travels.”  
...
- Network LCC plot: one clean PNG (dark background).  
- Network colored by dominant topic: one PNG.  
- Communities bar chart: one PNG.  
- Optional: degree distribution PNG (use as subtle background for 1s).

### Quick shooting checklist (feasible)
- Location: empty cinema or dark classroom with projector.  
- Gear: phone or DSLR on tripod; clip‑on mic or quiet room.  
- Shots to capture: presenter A‑roll (intro, bridge, close), over‑shoulder laptop (optional).  
- Audio: record one speaker; keep room quiet.

### Quick editing checklist
- Place A‑roll at 0–8s, 39–52s, and 53–60s.  
- Insert overlays at 9–38s as full‑screen with slow zooms.  
- Use simple cuts and 8–10 frame cross‑dissolves.  
- Titles/lower‑thirds: Inter/Roboto; keep text short.  
- Export H.264, 1080p, ~15–20 Mbps.
